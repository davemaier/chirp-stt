...
Press the hotkey (default `Ctrl+Shift`) to start/stop dictation. Transcribed text is typed into the active window.
...
```toml
primary_shortcut = "ctrl+shift"                 # Hotkey that toggles recording
